    ...
    for type in type_list:
        for data_type in data_type_list:
            ...
            for name in name_list:
                ...
                result_file2 = result_dir2 + "/" + type + "/" + data_type + "/" + name + "/deepgocnn_" + type + "_new"
                result_file3 = result_dir3 + "/" + type + "/" + data_type + "/" + name + "/deepgo_plus_" + type
                combine_result_single(result_file1, result_file2, result_file3, type, w, obo_dict)

    print("w=" + str(w) + ":")
    pipeline_list = ["deepgo_plus"]
...
if __name__ == '__main__':
    ...
    for w in range(62, 63, 1):

        workdir = sys.argv[1]

        result_dir1 = workdir + "/sagp/"
        result_dir2 = workdir + "/deepgocnn/"
        result_dir3 = workdir + "/deepgoplus/"
