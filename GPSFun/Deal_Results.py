...
def deal_results(origin_result_file, deal_result_dir, term_list_file, obo_dict, type):
    ...
    for protein_id in pro_list_dict:
        ...
        result_file = current_dir + "/gpsfun_" + type
...
if __name__ == '__main__':
    ...
    type_list = ["MF", "BP", "CC"]
    data_type_list = ["evaluate"]
    split_number = {"evaluate":49, "test":77}
    ...
    for type in type_list:
        for data_type in data_type_list:
            ...
            for number in range(1, split_number[data_type] + 1):

                origin_result_file = workdir + "/" + data_type + "_result/GO_preds" + str(number) + ".txt"
